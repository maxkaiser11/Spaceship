    ...
    public class Game1 : Game
    {
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            if (gameController.inGame == false)
            {
                ...
                int halfWidht = _graphics.PreferredBackBufferWidth / 2;
                _spriteBatch.DrawString(gameFont, menuMessage, new Vector2(halfWidht -  sizeOfText.X / 2, 200), Color.White);
            }
